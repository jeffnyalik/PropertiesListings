...
{
    public partial class propertiesModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainEntrance = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Security = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Gated = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Maintainance = table.Column<int>(type: "int", nullable: false),
